        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('guests.update', $guest->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $guest->date_of_birth) }}">
                </div>

                <div class="mb-3">
                    <label for="passport_number" class="form-label">Numéro de passeport</label>
                    <input type="text" class="form-control" id="passport_number" name="passport_number" value="{{ old('passport_number', $guest->passport_number) }}">
                </div>
