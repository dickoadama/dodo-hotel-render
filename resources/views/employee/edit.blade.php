...
@section('title', 'Modifier un Employé - DODO Hotel')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('employees.update', $employee->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="salary" name="salary" value="{{ old('salary', $employee->salary) }}" step="1" min="0" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="hire_date" class="form-label">Date d'embauche</label>
                            <input type="date" class="form-control" id="hire_date" name="hire_date" value="{{ old('hire_date', $employee->hire_date->format('Y-m-d')) }}" required>
                        </div>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary">Mettre à jour l'employé</button>
