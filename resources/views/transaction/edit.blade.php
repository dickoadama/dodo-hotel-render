...
@section('title', 'Modifier une Transaction - DODO Hotel')
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('transactions.update', $transaction->id) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="type" name="type" required>
                                <option value="income" {{ old('type', $transaction->type) == 'income' ? 'selected' : '' }}>Entrée</option>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="category" name="category" value="{{ old('category', $transaction->category) }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="amount" name="amount" value="{{ old('amount', $transaction->amount) }}" step="1" min="0" required>
                </div>
