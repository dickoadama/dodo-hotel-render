        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('hotels.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="geographical_location" name="geographical_location" rows="3">{{ old('geographical_location') }}</textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="star_rating" name="star_rating" required>
                        <option value="0" {{ old('star_rating') == 0 ? 'selected' : '' }}>0 étoile</option>
                        <option value="1" {{ old('star_rating') == 1 ? 'selected' : '' }}>1 étoile</option>
                        <option value="2" {{ old('star_rating') == 2 ? 'selected' : '' }}>2 étoiles</option>
                        <option value="3" {{ old('star_rating') == 3 ? 'selected' : '' }}>3 étoiles</option>
                        <option value="4" {{ old('star_rating') == 4 ? 'selected' : '' }}>4 étoiles</option>
                        <option value="5" {{ old('star_rating') == 5 ? 'selected' : '' }}>5 étoiles</option>
                    </select>
                </div>
