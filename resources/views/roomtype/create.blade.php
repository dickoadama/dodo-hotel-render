        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('room-types.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="base_price" name="base_price" value="{{ old('base_price') }}" step="1" min="0" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="ventilation" name="ventilation" required>
                        <option value="climatisee" {{ old('ventilation') == 'climatisee' ? 'selected' : '' }}>Climatisée</option>
                        <option value="ventilee" {{ old('ventilation') == 'ventilee' ? 'selected' : '' }}>Ventilée</option>
                    </select>
                </div>

                <button type="submit" class="btn btn-primary">Ajouter le type de chambre</button>
