            ...
            <form action="{{ route('reservations.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="total_price" name="total_price" value="{{ old('total_price') }}" step="1" min="0" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="status" name="status" required>
                        ...
                        <option value="checked_in" {{ old('status') == 'checked_in' ? 'selected' : '' }}>Check-in</option>
                        <option value="checked_out" {{ old('status') == 'checked_out' ? 'selected' : '' }}>Check-out</option>
