...
@section('title', 'Mot de passe oublié - DODO Hotel')
            ...
            <div class="card border-0 shadow-lg rounded-15">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="auth-container">
                        ...
                        <div id="forgot-password-form" class="auth-form slide-in">
                            <h3 class="text-center form-title">Mot de passe oublié</h3>
                            <p class="text-center text-muted mb-4">Entrez votre adresse email pour recevoir un lien de réinitialisation</p>
