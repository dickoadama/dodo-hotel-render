...
@section('title', 'Ajouter une Caisse - DODO Hotel')
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('cash-registers.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="balance" name="balance" value="{{ old('balance', 0) }}" step="1" min="0">
                </div>
                ...
                <button type="submit" class="btn btn-primary">Ajouter la caisse</button>
