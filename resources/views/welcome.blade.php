...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>DODO Hotel - Accueil</title>
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="hero-section p-6">
                    <div class="text-center">
                        <h1 class="text-4xl font-bold mb-4">Bienvenue à l'Hôtel DODO</h1>
                        <p class="text-lg mb-6">Votre confort est notre priorité. Découvrez nos chambres confortables et nos services exceptionnels.</p>
